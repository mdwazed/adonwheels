<div class="list-group">
      <a href=<?php echo base_url('index.php/Admin_controller/show_pending_request'); ?> class="list-group-item">Pending Request</a>
      <a href="#" class="list-group-item">Active Contracts</a>
