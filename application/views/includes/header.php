...
<!-- this template is based on modern business from startbootstrap.com -->
<!DOCTYPE html>
<html lang="en">

<head>
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-119232212-1"></script>
    <script>
    ...
    <title>Add on wheels</title>

    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url('css/bootstrap.min.css'); ?>" rel="stylesheet" type="text/css">
    

    <!-- Custom CSS from modern business-->
